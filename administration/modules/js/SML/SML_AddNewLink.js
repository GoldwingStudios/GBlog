$(document).ready(function() {
    ...
    $("#AddSocialMediaLink").on("click", function() {
        ...
        var AddSML_HTML_String = '<div id="SML_ID_' + Link_ID + '" class = "social_media">\n\
                                    <input id="' + Link_ID + '_type" class="social_media_input_type" name="sml_type[]" type="text" placeholder="Input a Type!"/>\n\
                                    <input id="' + Link_ID + '_link" class="social_media_input_link" name="sml_link[]" type="text" placeholder="Input a link" / >\n\
                                    <img id="' + Link_ID + '" class="SML_delete_Link" src="../assets/images/delete.svg" />\n\
                                </div>';
        $(".SML_Entry_Container").append(AddSML_HTML_String);
    });
